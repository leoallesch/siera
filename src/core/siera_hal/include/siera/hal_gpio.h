...
typedef struct siera_hal_gpio_t {
  int (*configure)(struct siera_hal_gpio_t* self, uint32_t pin, siera_gpio_dir_t dir, siera_gpio_pull_t pull);
...
static inline int siera_gpio_configure(siera_hal_gpio_t* self, uint32_t pin, siera_gpio_dir_t dir, siera_gpio_pull_t pull)
{
