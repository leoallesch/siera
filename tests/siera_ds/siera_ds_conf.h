...
#define SIERA_DS_KEYS(KEY) \
    ...
    KEY(ALARM_HOUR,    uint8_t,  SIERA_DS_PERSIST, 7,     SIERA_DS_NONE)     \
    KEY(ALARM_MIN,     uint8_t,  SIERA_DS_PERSIST, 0,     SIERA_DS_NONE)     \
    KEY(ALARM_ENABLED, bool,     SIERA_DS_PERSIST, false, SIERA_DS_NONE)     \
    KEY(BRIGHTNESS,    uint8_t,  SIERA_DS_PERSIST, 128,   SIERA_DS_NONE)     \
